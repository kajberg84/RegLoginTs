 ...
 */
 ...
 refreshRouter.post('/', (req, res, next) => {
   try {
     ...
     // HÄR BÖR JAG KOLLA SÅ DET ÄR EN GILTIG REFRESH TOKEN FRÅN DATABASEN
     // implemtentera login så sparar jag undan reftoken i databasen
     //  {
     //    user: kossa2,
     //    reftoken: refreshToken,
     //  }
     //  kolla så det från db är giltig
